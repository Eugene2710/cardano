"""updated sqlAlchemy tables

Revision ID: a6f2b5d040a9
Revises: 
Create Date: 2025-03-30 12:10:53.009866
...
def upgrade() -> None:
    ...
    sa.Column('block_height', sa.Integer(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.PrimaryKeyConstraint('table', 'block_height')
    )
