...
class CardanoTransactionsTOETLPipeline:
    ...
    async def run(self) -> None:
        ...
        # start_block_height: int = tx_latest_block_height + 1 or 1
        ...
        end_block_height: int = start_block_height+200
        ...
        while curr <= end_block_height:
            ...
            block_ids: list[str] = [str(i) for i in range(curr, end_batch+1)]
...
def run():
    ...
    event_loop.run_until_complete(cardano_tx_to_s3_etl_pipeline.run())
