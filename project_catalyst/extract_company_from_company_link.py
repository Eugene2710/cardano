...
if __name__ == "__main__":
    # read CSV
    df = pd.read_csv("/Users/eugeneleejunping/Documents/cardano_grants/project_catalyst/before_extracting_company.csv")
    # parse the "Company Link" column into a list
    company_links: list[str] = df['Company Link'].to_list()
    ...
    df.to_csv("extracted_companies_from_catalyst.csv", index=False)
